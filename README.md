...
**Indicacion especial!**
Al registrar un usuario nuevo, esta API pedirá un booleano para la key "admin". Esto es unicamente con propositos demostrativos y no representa el comportamiento indicado en un entorno de produccion.
